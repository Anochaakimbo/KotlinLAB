                        ...
                        TextButton(
                            onClick = {
                                ...
                                navController.currentBackStackEntry?.savedStateHandle?.set("data",
                                    Student(item.no,item.std_id,item.std_name,item.std_gender,item.std_age)
                                )
        ...
        .enqueue(object : Callback<List<Student>> {
            override fun onResponse(call : Call<List<Student>>,
                ...
                response.body()?.forEach{
                    studentItemsList.add(Student(it.no,it.std_id,it.std_name,it.std_gender,it.std_age))
                }
            }
